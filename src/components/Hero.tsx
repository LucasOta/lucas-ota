  ...
  return (
    <section className='min-h-screen flex items-center justify-center px-6 md:px-12'>
      <div className='max-w-4xl mx-auto text-center'>
        ...
        >
          I thrive at the intersection of code and business, translating
          real-world needs into meaningful software. Currently diving deep into
          AI tools to streamline workflows and help teams ship smarter.
        </motion.p>
      </div>
    </section>
  )
