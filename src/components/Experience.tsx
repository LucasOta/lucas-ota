          ...
          {experiences.map((exp, index) => (
            ...
            >
              <div className='flex flex-col md:flex-row md:justify-between md:items-start mb-4'>
                <div>
                  <h3 className='text-xl md:text-2xl font-semibold text-primary hover:text-accent transition-colors duration-200'>
                    {exp.position}
                  </h3>
                ...
                <span className='text-secondary font-medium mt-2 md:mt-0'>
                  {exp.period}
                </span>
              </div>
